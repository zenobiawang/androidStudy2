...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private PagerSlidingTabStrip.PageListener pageListener = new PageListener();
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof TabStyleProvider) {
                addTab(i, ((TabStyleProvider) pager.getAdapter()).getTabView(i, currentPosition));
            } else {
